...
public class UnreliNETNormal
{
  ...
  public UnreliNETNormal(int sk1_dst_port, int sk2_dst_port, int sk3_dst_port, int sk4_dst_port)
  {
	...
	{	  
	  ...
	  if (args.length != 4)
	  {
	    System.err.println("Usage: java UnreliNETNormal sk1_dst_port, sk2_dst_port, sk3_dst_port, sk4_dst_port");
	    System.exit(-1);
	  }
	  else
	  {
	    new UnreliNETNormal(Integer.parseInt(args[0]), Integer.parseInt(args[1]), Integer.parseInt(args[2]), Integer.parseInt(args[3]));
	  }
	}
}
